...
<div class="account-view">
    ...
    <div class="account-content">
        <p class="header-text"><?php if (!isset($edit)) : ?>Добавить<?php else : ?>Изменить<?php endif; ?> спонсора</p>
        <div class="orders">
            <?php if (isset($error)) : ?>
                <div>
                    <h2><?= $error ?></h2>
            ...
            <div class="admin-form">
                <form action="/profile/admin/sponsors/<?php if (isset($edit)) : ?>edit<?php else : ?>add<?php endif; ?>/" enctype="multipart/form-data" method="post" style="display: flex; flex-direction: column; justify-items: left; height: 100%">
                    <div style="width: 100%">
                    ...
                    <div style="width: 100%">
                        <label class="label-admin-form" for="link">Ссылка на сайт</label>
